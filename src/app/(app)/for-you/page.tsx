  ...
  return (
    <div className="app-page">
      <section className="mb-10">
        ...
        {selected && (
          <Link href={`/book/${selected.id}`} style={{ display: "flex", gap: "24px", backgroundColor: "#FBEFD6", borderRadius: "8px", padding: "24px", textDecoration: "none", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", gap: "16px", alignItems: "center", flex: 1 }}>
              <figure style={{ position: "relative", width: "140px", height: "140px", flexShrink: 0 }}>
                {selected.imageLink && (
                  <Image src={selected.imageLink} alt={selected.title} fill sizes="140px" className="object-contain" />
                )}
              </figure>
              <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "16px", fontSize: "14px", color: "#032b41" }}>
                  <span style={{ display: "flex", alignItems: "center", gap: "4px" }}><BiTime /> 3 mins</span>
                  <span style={{ display: "flex", alignItems: "center", gap: "4px" }}><BsStar /> {selected.averageRating}</span>
                </div>
              </div>
            </div>
          </Link>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-[#032b41] mb-1">Recommended For You</h2>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-[#032b41] mb-1">Suggested Books</h2>
