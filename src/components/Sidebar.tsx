...
export default function Sidebar() {
  ...
  const renderItem = (item: NavItem) => {
    ...
    return <Link key={item.label} href={item.href!} style={{ color: "#032b41", textDecoration: "none" }}>{content}</Link>;
  };

  return (
    <aside style={{ position: "fixed", top: 0, left: 0, height: "100vh", width: "220px", backgroundColor: "#fff", borderRight: "1px solid #e1e7ea", display: "flex", flexDirection: "column", zIndex: 40 }}>
      ...
      <div style={{ padding: "16px 0", borderTop: "1px solid #e1e7ea" }}>
        ...
        >
          {user ? <BiLogOut size={24} /> : <BiLogIn size={24} />}
